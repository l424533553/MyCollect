//package com.collect.user_luo.mycollect.test.eventdispatch;
//
//
//
...
///**
// * 作者：罗发新
// * 时间：2019/6/26 0026    星期三
// * 邮件：424533553@qq.com
// * 说明：  汉字： 注解的方法为 同名注解的方法
// */
...
//     * a pointer id inside a {@link android.view.MotionEvent}.
//     */
...
//     * root {@link android.view.View} or in the appropriate {@link Window.Callback}
...
//     * This action is not a touch event so it is delivered to
//     * {@link android.view.View#onGenericMotionEvent(android.view.MotionEvent)} rather than
//     * {@link View#onTouchEvent(android.view.MotionEvent)}.
//     * </p>
//     */
...
//            gSharedTempPointerProperties = android.view.MotionEvent.PointerProperties.createArray(capacity);
...
//                                                int pointerCount, android.view.MotionEvent.PointerProperties[] pointerIds, android.view.MotionEvent.PointerCoords[] pointerCoords);
...
//                                              android.view.MotionEvent.PointerCoords[] pointerCoords, int metaState);
//    private static native void nativeGetPointerCoords(long nativePtr,
//                                                      int pointerIndex, int historyPos, android.view.MotionEvent.PointerCoords outPointerCoords);
//    private static native void nativeGetPointerProperties(long nativePtr,
//                                                          int pointerIndex, android.view.MotionEvent.PointerProperties outPointerProperties);
//
...
//    }
//
//    static private android.view.MotionEvent obtain() {
//        final android.view.MotionEvent ev;
...
//     * a {@link android.view.MotionEvent.PointerProperties} property object for each pointer, which must
//     * include the pointer identifier.
//     * @param pointerCoords An array of <em>pointerCount</em> values providing
//     * a {@link android.view.MotionEvent.PointerCoords} coordinate object for each pointer.
...
//     */
//    static public android.view.MotionEvent obtain(long downTime, long eventTime,
//                                                  int action, int pointerCount, android.view.MotionEvent.PointerProperties[] pointerProperties,
...
//    @Deprecated
//    static public android.view.MotionEvent obtain(long downTime, long eventTime,
//                                                  int action, int pointerCount, int[] pointerIds, android.view.MotionEvent.PointerCoords[] pointerCoords,
//                                                  int metaState, float xPrecision, float yPrecision, int deviceId,
//                                                  int edgeFlags, int source, int flags) {
//        synchronized (gSharedTempLock) {
//            ensureSharedTempPointerCapacity(pointerCount);
//            final android.view.MotionEvent.PointerProperties[] pp = gSharedTempPointerProperties;
...
//     * MotionEvent.
//     */
//    static public android.view.MotionEvent obtain(long downTime, long eventTime, int action,
...
//            pp[0].id = 0;
//
//            final android.view.MotionEvent.PointerCoords pc[] = gSharedTempPointerCoords;
//            pc[0].clear();
//            pc[0].x = x;
//            pc[0].y = y;
...
//     */
//    static public android.view.MotionEvent obtain(android.view.MotionEvent other) {
//        if (other == null) {
...
//     */
//    static public android.view.MotionEvent obtainNoHistory(android.view.MotionEvent other) {
//        if (other == null) {
//            throw new IllegalArgumentException("other motion event must not be null");
//        }
//
...
//
//    /**
//     * 注解：返回正在执行的屏蔽操作，不包含指针索引信息。
//     * 使用@link getactionindex返回与指针操作关联的索引。
...
//
//    /**
//     * Populates a {@link android.view.MotionEvent.PointerCoords} object with pointer coordinate data for
...
//     */
//    public final void getPointerCoords(int pointerIndex, android.view.MotionEvent.PointerCoords outPointerCoords) {
//        nativeGetPointerCoords(mNativePtr, pointerIndex, HISTORY_CURRENT, outPointerCoords);
//    }
//
//    /**
//     * Populates a {@link android.view.MotionEvent.PointerProperties} object with pointer properties for
//     * the specified pointer index.
//     *
//     * @param pointerIndex Raw index of pointer to retrieve.  Value may be from 0
//     * (the first pointer that is down) to {@link #getPointerCount()}-1.
...
//
//    /**
//     * Populates a {@link android.view.MotionEvent.PointerCoords} object with historical pointer coordinate data,
...
//     * @param metaState Meta key state.
//     */
//    public final void addBatch(long eventTime, android.view.MotionEvent.PointerCoords[] pointerCoords, int metaState) {
...
//     * @hide
//     */
//    public final android.view.MotionEvent clampNoHistory(float left, float top, float right, float bottom) {
//        android.view.MotionEvent ev = obtain();
//        synchronized (gSharedTempLock) {
//            final int pointerCount = nativeGetPointerCount(mNativePtr);
//
...
//        }
//
//        appendUnless("0", msg, ", buttonState=", android.view.MotionEvent.buttonStateToString(getButtonState()));
...
//    }
//
//    public static final Parcelable.Creator<android.view.MotionEvent> CREATOR
//            = new Parcelable.Creator<android.view.MotionEvent>() {
//        public android.view.MotionEvent createFromParcel(Parcel in) {
...
//
//    /** @hide */
//    public static android.view.MotionEvent createFromParcelBody(Parcel in) {
//        android.view.MotionEvent ev = obtain();
...
//     * creating new {@link android.view.MotionEvent} objects and to query pointer coordinates
//     * in bulk.
//     *
...
//            android.view.MotionEvent.PointerCoords[] array = new android.view.MotionEvent.PointerCoords[size];
...
//     * when creating new {@link android.view.MotionEvent} objects and to query pointer properties in bulk.
//     */
...
//            android.view.MotionEvent.PointerProperties[] array = new android.view.MotionEvent.PointerProperties[size];
//            for (int i = 0; i < size; i++) {
...
//            if (other instanceof android.view.MotionEvent.PointerProperties) {
//                return equals((android.view.MotionEvent.PointerProperties)other);
//            }
//            return false;
//        }
//
//        private boolean equals(android.view.MotionEvent.PointerProperties other) {
