...
public class BuglyUPHelper {
    ...
    public static final String APP_ID = "01cd5b631b";
...
//        Beta.upgradeCheckPeriod = 60 * 1000;
         ...
         */
//        Beta.canShowUpgradeActs.add(DataDemoActivity.class);
            ...
            public void onResume(final Context context, View view, UpgradeInfo upgradeInfo) {
                ...
                imageView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        //TODO 自定义控制
                        Intent intent = new Intent(context, BuglyOtherActivity.class);
    ...
    /**
     * 更新资源监听 ，注意》》》 放在Bugly.init()  前面，否则无作用
     * 1.设置该监听后，可能不再弹出更新提示框  即 setUILifecycleListener 方法不再有效
     */
    public void setUpgradeListener() {
        ...
        Beta.upgradeListener = new UpgradeListener() {
            ...
            public void onUpgrade(int ret, UpgradeInfo strategy, boolean isManual, boolean isSilence) {
                Log.d(TAG, "UpgradeListener");
                if (strategy != null) {
                    Intent i = new Intent();
                    // 自定义的更新Activty
                    i.setClass(context, UpgradeActivity.class);
     ...
     * 设定监听 更新状态
     */
    public void setUpgradeStateListener() {
        /* 设置更新状态回调接口 */
        Beta.upgradeStateListener = new UpgradeStateListener() {
            ...
            public void onUpgrading(boolean isManual) {
                Toast.makeText(context, "UPGRADE_CHECKING", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onDownloadCompleted(boolean b) {
                Toast.makeText(context, "DOWN_LOAD", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onUpgradeNoVersion(boolean isManual) {
                Toast.makeText(context, "UPGRADE_NO_VERSION", Toast.LENGTH_SHORT).show();
            }
        };
