...
//
//    /**
//     * 当触摸屏事件未由其下的任何视图处理时调用。这对于处理发生在窗口边界之外
//     * 的触摸事件非常有用，因为在那里没有视图可以接收它。
//     * Called when a touch screen event was not handled by any of the views
//     * under it.  This is most useful to process touch events that happen
//     * outside of your window bounds, where there is no view to receive it.
//     *
//     * @param event The touch screen event being processed.   出现要处理的的事件
//     *
//     * @return Return true if you have consumed the event, false if you haven't.
//     * The default implementation always returns false.   默认返回false,返回true,表示事件被消耗了
//     */
...
//
//    /**
//     * 调用以处理触摸屏事件。你可以重写该选项，在触摸事件被分发给window之前截获它，并重写该选项
//     *  对于应该正常处理的触摸屏事件，一定要调用此实现。
//     */
//    /**
...
//
//    /**
//     * Same as calling {@link #startActivityFromChild(android.app.Activity, Intent, int, Bundle)}
//     * with no options.
//     *
//     * @param child The activity making the call.
//     * @param intent The intent to start.
...
//     * @see #startActivityForResult
//     */
//    public void startActivityFromChild(@NonNull android.app.Activity child, @RequiresPermission Intent intent,
//                                       int requestCode) {
...
//
//    /**
//     * Same as calling {@link #startIntentSenderFromChild(android.app.Activity, IntentSender,
//     * int, Intent, int, int, int, Bundle)} with no options.
//     */
//    public void startIntentSenderFromChild(android.app.Activity child, IntentSender intent,
...
//
//    /**
//     * Like {@link #startActivityFromChild(android.app.Activity, Intent, int)}, but
...
//     *                    activity.
//     */
//    public void finishActivityFromChild(@NonNull android.app.Activity child, int requestCode) {
//        try {
//            ActivityManager.getService()
...
//    }
//
//    protected void onChildTitleChanged(android.app.Activity childActivity, CharSequence title) {
//    }
//
//    /**
...
//     *         not be found and this activity was simply finished normally.
//     */
//    public boolean navigateUpToFromChild(android.app.Activity child, Intent upIntent) {
...
//
//    /**
//     * When {@link android.app.ActivityOptions#makeSceneTransitionAnimation(android.app.Activity,
...
//            Intent resultData = (resultCode == android.app.Activity.RESULT_OK) ? data : null;
...
//
//    /**
//     * Interface for informing a translucent {@link android.app.Activity} once all visible activities below it
//     * have completed drawing. This is necessary only after an {@link android.app.Activity} has been made
//     * opaque using {@link android.app.Activity#convertFromTranslucent()} and before it has been drawn
//     * translucent again following a call to {@link
//     * android.app.Activity#convertToTranslucent(android.app.Activity.TranslucentConversionListener,
//     * ActivityOptions)}
//     *
//     * @hide
//     */
...
//        /**
//         * Callback made following {@link android.app.Activity#convertToTranslucent} once all visible Activities
...
//         *
//         * @see android.app.Activity#convertFromTranslucent()
//         * @see android.app.Activity#convertToTranslucent(TranslucentConversionListener, ActivityOptions)
//         */
...
//
//    /**
//     * Specifies whether an {@link android.app.Activity} should be shown on top of the the lock screen whenever
...
//     *
//     * @param showWhenLocked {@code true} to show the {@link android.app.Activity} on top of the lock screen;
...
//     * KeyguardManager#requestDismissKeyguard(android.app.Activity, KeyguardManager.KeyguardDismissCallback)}
...
//    }
//
//    class HostCallbacks extends FragmentHostCallback<android.app.Activity> {
//        public HostCallbacks() {
//            super(android.app.Activity.this /*activity*/);
//        }
//
//        @Override
//        public void onDump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
//            android.app.Activity.this.dump(prefix, fd, writer, args);
//        }
//
//        @Override
...
//            final LayoutInflater result = android.app.Activity.this.getLayoutInflater();
//            if (onUseFragmentManagerInflaterFactory()) {
//                return result.cloneInContext(android.app.Activity.this);
//            }
//            return result;
//        }
//
...
//                                                Bundle options) {
//            android.app.Activity.this.startActivityFromFragment(fragment, intent, requestCode, options);
//        }
//
//        @Override
...
//                UserHandle user) {
//            android.app.Activity.this.startActivityAsUserFromFragment(
...
//            return android.app.Activity.this.findViewById(id);
//        }
//
//        @Override
