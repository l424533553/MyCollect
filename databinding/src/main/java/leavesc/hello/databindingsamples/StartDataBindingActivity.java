...
import leavesc.hello.databindingdemo.activity.DataDemoActivity;
 ...
 */
public class StartDataBindingActivity extends AppCompatActivity {
    ...
    public void startActivity14(View view) {
        ...
        startActivity(CommonAdapterActivity.class);
    }
    public void startActivity15(View view) {
        startActivity(DataDemoActivity.class);
    }
