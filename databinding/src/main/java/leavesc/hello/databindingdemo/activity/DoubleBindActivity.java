...
import leavesc.hello.databindingdemo.bean.DoubleBindBean;
import leavesc.hello.databindingdemo.bean.DoubleBindBean2;
import leavesc.hello.databindingsamples.R;
import leavesc.hello.databindingsamples.databinding.ActivityDoubleBindBinding;
...
public class DoubleBindActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.change_content_btn) {//BaseObservable
            flag = !flag;
            if (flag) {
        ...
        } else if (i == R.id.change_content_btn2) {//ObservableFields
            flag2 = !flag2;
            if (flag2) {
        ...
        } else if (i == R.id.change_content_btn3) {
            list.set(0, "after change list");
        } else if (i == R.id.change_content_btn4) {
